...
MODEL_DIR="$HOME/Benchmark_AMDAIMAX395/models/ornith-1.0-35b-q4-gguf"
MODEL_FILE="$MODEL_DIR/ornith-1.0-35b-Q4_K_M.gguf"
LLAMA_SERVER="$HOME/llama.cpp/build/bin/llama-server"
PORT=8080
ALIAS="ornith-1.0-35b"
LOG_DIR="$MODEL_DIR/logs"
RESULT_CSV="$MODEL_DIR/051_ornith-1.0-35b_stressadv_results.csv"
SERVER_LOG="$LOG_DIR/051_ornith-1.0-35b_stressadv_server.log"
MAX_TOKENS=100
MARGIN=1700
...
echo "[開始] 壓測腳本 051 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
