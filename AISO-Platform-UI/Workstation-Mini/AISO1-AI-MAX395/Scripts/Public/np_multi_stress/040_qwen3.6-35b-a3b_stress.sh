...
RESULT_CSV="$MODEL_DIR/040_qwen3.6-35b-a3b_stress_results.csv"
SERVER_LOG="$LOG_DIR/040_qwen3.6-35b-a3b_stress_server.log"
MAX_TOKENS=100
MARGIN=1700
...
echo "[開始] 壓測腳本 040 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
