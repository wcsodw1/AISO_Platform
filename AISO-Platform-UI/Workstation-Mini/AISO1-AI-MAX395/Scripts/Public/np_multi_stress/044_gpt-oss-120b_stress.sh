...
RESULT_CSV="$MODEL_DIR/044_gpt-oss-120b_stress_results.csv"
SERVER_LOG="$LOG_DIR/044_gpt-oss-120b_stress_server.log"
MAX_TOKENS=100
MARGIN=1700
...
echo "[開始] 壓測腳本 044 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
