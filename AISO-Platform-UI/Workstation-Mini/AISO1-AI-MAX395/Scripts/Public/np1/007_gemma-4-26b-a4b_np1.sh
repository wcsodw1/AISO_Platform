...
RESULT_CSV="$MODEL_DIR/007_gemma-4-26b-a4b_np1_results.csv"
SERVER_LOG="$LOG_DIR/007_gemma-4-26b-a4b_np1_server.log"
...
echo "[開始] 腳本 007 開始執行時間: $SCRIPT_START_HUMAN"
...
echo ""
echo "[結束] 腳本 007 結束時間: $SCRIPT_END_HUMAN"
