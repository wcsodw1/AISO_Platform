...
RESULT_CSV="$MODEL_DIR/001_qwen3.6-35b-a3b_np1_results.csv"
SERVER_LOG="$LOG_DIR/001_qwen3.6-35b-a3b_np1_server.log"
...
echo "[開始] 腳本 001 開始執行時間: $SCRIPT_START_HUMAN"
...
echo ""
echo "[結束] 腳本 001 結束時間: $SCRIPT_END_HUMAN"
