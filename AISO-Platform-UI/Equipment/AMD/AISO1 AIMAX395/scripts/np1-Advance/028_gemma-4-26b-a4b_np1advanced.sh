#!/bin/bash
# ============================================
# AMD AI Max+ 395 - Gemma-4-26B-A4B (Q4_K_M) Advanced ctx 測試
...
RESULT_CSV="$MODEL_DIR/028_gemma-4-26b-a4b_np1advanced_results.csv"
PORT=8080
ALIAS="gemma-4-26b-a4b-advanced"
...
echo "[開始] 腳本 028 (Advanced ctx) 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
...
for ctx in "${CTX_LIST[@]}"; do
  ...
  ACTUAL_CTX="NA"
  LOGFILE="$LOG_DIR/028_ctx${ctx}_$(date +%H%M%S).log"
