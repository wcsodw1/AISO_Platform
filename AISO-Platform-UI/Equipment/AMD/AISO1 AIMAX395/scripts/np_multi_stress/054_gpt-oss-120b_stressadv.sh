...
# 模型: gpt-oss-120b
# 測試型態: 真實高ctx併發壓力測試 Advanced版(np=2/4/8/16, ctx=4K/8K/16K/32K/64K，已移除與一般版重疊組合)
# 組合數: 8 組 (每組3輪)
# -c = 目標ctx × np (確保每slot不被瓜分)
# ============================================================
set -u

MODEL_DIR="$HOME/Benchmark_AMDAIMAX395/models/gpt-oss-120b-q4-gguf"
MODEL_FILE="$MODEL_DIR/UD-Q4_K_XL/gpt-oss-120b-UD-Q4_K_XL-00001-of-00002.gguf"
LLAMA_SERVER="$HOME/llama.cpp/build/bin/llama-server"
PORT=8080
ALIAS="gpt-oss-120b"
LOG_DIR="$MODEL_DIR/logs"
RESULT_CSV="$MODEL_DIR/054_gpt-oss-120b_stressadv_results.csv"
SERVER_LOG="$LOG_DIR/054_gpt-oss-120b_stressadv_server.log"
MAX_TOKENS=100
MARGIN=1700
...
echo "[開始] 壓測腳本 054 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
...
COMBO_LIST=("4000 16" "8000 16" "16000 16" "32000 16" "64000 2" "64000 4" "64000 8" "64000 16")
