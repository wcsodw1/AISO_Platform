...
MODEL_DIR="$HOME/Benchmark_AMDAIMAX395/models/qwen3.6-35b-a3b-q4-gguf"
MODEL_FILE="$MODEL_DIR/Qwen3.6-35B-A3B-UD-Q4_K_M.gguf"
LLAMA_SERVER="$HOME/llama.cpp/build/bin/llama-server"
PORT=8080
ALIAS="qwen3.6-35b-a3b"
LOG_DIR="$MODEL_DIR/logs"
RESULT_CSV="$MODEL_DIR/050_qwen3.6-35b-a3b_stressadv_results.csv"
SERVER_LOG="$LOG_DIR/050_qwen3.6-35b-a3b_stressadv_server.log"
MAX_TOKENS=100
MARGIN=1700
...
echo "[開始] 壓測腳本 050 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
