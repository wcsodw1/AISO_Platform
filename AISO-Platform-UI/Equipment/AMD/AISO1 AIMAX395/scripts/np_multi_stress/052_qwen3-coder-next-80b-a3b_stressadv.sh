...
RESULT_CSV="$MODEL_DIR/052_qwen3-coder-next-80b-a3b_stressadv_results.csv"
SERVER_LOG="$LOG_DIR/052_qwen3-coder-next-80b-a3b_stressadv_server.log"
MAX_TOKENS=100
MARGIN=1700
...
echo "[開始] 壓測腳本 052 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
