...
MODEL_DIR="$HOME/Benchmark_AMDAIMAX395/models/magistral-small-2509-q4-gguf"
MODEL_FILE="$MODEL_DIR/Magistral-Small-2509-Q4_K_M.gguf"
LLAMA_SERVER="$HOME/llama.cpp/build/bin/llama-server"
PORT=8080
ALIAS="magistral-small-2509"
LOG_DIR="$MODEL_DIR/logs"
RESULT_CSV="$MODEL_DIR/011_magistral-small-2509_np1_results.csv"
SERVER_LOG="$LOG_DIR/011_magistral-small-2509_np1_server.log"
...
echo "[開始] 腳本 011 開始執行時間: $SCRIPT_START_HUMAN"
...
echo ""
echo "[結束] 腳本 011 結束時間: $SCRIPT_END_HUMAN"
