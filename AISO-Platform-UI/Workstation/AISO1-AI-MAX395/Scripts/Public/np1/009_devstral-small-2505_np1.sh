...
MODEL_DIR="$HOME/Benchmark_AMDAIMAX395/models/devstral-small-2505-q4-gguf"
MODEL_FILE="$MODEL_DIR/Devstral-Small-2505-Q4_K_M.gguf"
LLAMA_SERVER="$HOME/llama.cpp/build/bin/llama-server"
PORT=8080
ALIAS="devstral-small-2505"
LOG_DIR="$MODEL_DIR/logs"
RESULT_CSV="$MODEL_DIR/009_devstral-small-2505_np1_results.csv"
SERVER_LOG="$LOG_DIR/009_devstral-small-2505_np1_server.log"
...
echo "[開始] 腳本 009 開始執行時間: $SCRIPT_START_HUMAN"
...
echo ""
echo "[結束] 腳本 009 結束時間: $SCRIPT_END_HUMAN"
