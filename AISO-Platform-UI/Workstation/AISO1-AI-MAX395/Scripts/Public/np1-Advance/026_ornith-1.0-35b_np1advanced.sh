#!/bin/bash
# ============================================
# AMD AI Max+ 395 - Ornith-1.0-35B (Q4_K_M) Advanced ctx 測試
...
RESULT_CSV="$MODEL_DIR/026_ornith-1.0-35b_np1advanced_results.csv"
PORT=8080
ALIAS="ornith-1.0-35b-advanced"
...
echo "[開始] 腳本 026 (Advanced ctx) 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
...
for ctx in "${CTX_LIST[@]}"; do
  ...
  ACTUAL_CTX="NA"
  LOGFILE="$LOG_DIR/026_ctx${ctx}_$(date +%H%M%S).log"
