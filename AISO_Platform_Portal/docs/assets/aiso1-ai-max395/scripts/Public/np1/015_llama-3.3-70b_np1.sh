...
MODEL_DIR="$HOME/Benchmark_AMDAIMAX395/models/llama-3.3-70b-q4-gguf"
MODEL_FILE="$MODEL_DIR/Llama-3.3-70B-Instruct-UD-Q4_K_XL.gguf"
LLAMA_SERVER="$HOME/llama.cpp/build/bin/llama-server"
PORT=8080
ALIAS="llama-3.3-70b"
LOG_DIR="$MODEL_DIR/logs"
RESULT_CSV="$MODEL_DIR/015_llama-3.3-70b_np1_results.csv"
SERVER_LOG="$LOG_DIR/015_llama-3.3-70b_np1_server.log"
...
echo "[開始] 腳本 015 開始執行時間: $SCRIPT_START_HUMAN"
...
echo ""
echo "[結束] 腳本 015 結束時間: $SCRIPT_END_HUMAN"
