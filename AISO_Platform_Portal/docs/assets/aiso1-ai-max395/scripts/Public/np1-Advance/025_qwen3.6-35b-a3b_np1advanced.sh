#!/bin/bash
# ============================================
# AMD AI Max+ 395 - Qwen3.6-35B-A3B (Q4_K_M) Advanced ctx 測試
...
RESULT_CSV="$MODEL_DIR/025_qwen3.6-35b-a3b_np1advanced_results.csv"
PORT=8080
ALIAS="qwen3.6-35b-a3b-advanced"
...
echo "[開始] 腳本 025 (Advanced ctx) 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
...
for ctx in "${CTX_LIST[@]}"; do
  ...
  ACTUAL_CTX="NA"
  LOGFILE="$LOG_DIR/025_ctx${ctx}_$(date +%H%M%S).log"
