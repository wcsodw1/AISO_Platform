...
MODEL_DIR="$HOME/Benchmark_AMDAIMAX395/models/gemma-4-26b-a4b-q4-gguf"
MODEL_FILE="$MODEL_DIR/gemma-4-26B-A4B-it-UD-Q4_K_M.gguf"
LLAMA_SERVER="$HOME/llama.cpp/build/bin/llama-server"
PORT=8080
ALIAS="gemma-4-26b-a4b"
LOG_DIR="$MODEL_DIR/logs"
RESULT_CSV="$MODEL_DIR/053_gemma-4-26b-a4b_stressadv_results.csv"
SERVER_LOG="$LOG_DIR/053_gemma-4-26b-a4b_stressadv_server.log"
MAX_TOKENS=100
MARGIN=1700
...
echo "[開始] 壓測腳本 053 開始執行時間: $(date '+%Y-%m-%d %H:%M:%S')"
